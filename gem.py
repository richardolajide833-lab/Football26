...
# ========== CONFIG ==========
GEMINI_API_KEY = os.getenv("AIzaSyCyvHZNLgDpNhQWCX_fk3DeXXsYbzoYh2M", "YOUR_GEMINI_API_KEY")
TELEGRAM_TOKEN = os.getenv( "8391581528:AAFU5L3wBnIXhHtGy8MoJpWiNbLs7KkksY8", "8391581528:AAFU5L3wBnIXhHtGy8MoJpWiNbLs7KkksY8")
FOOTBALL_KEY   = os.getenv("11af2951ce774a65a2623f15b5595b51", "YOUR_FOOTBALL_DATA_API_KEY")
ADMIN_CHAT_ID  = os.getenv("7560577462", "YOUR_ADMIN_CHAT_ID")  # numeric string
